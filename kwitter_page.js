...
dislike_btn="<button class='btn btn-warning' id="+firebase_message_id+" value="+dislike+" onclick='update_ dislike(this.id)'>";
span="<span class='glyphicon glyphicon-thumbs-up'>Like:"+like+"</span></button><hr>";
span="<span class='glyphicon glyphicon-thumbs-down'>Like:"+like+"</span></button><hr>";
...
function update_dislike(message_id){
      btnid=message_id;
      dislikes=document.getElementById(btnId).value;
      updated_likes=Number(dislikes)+1;
      firebase.database().ref(room_name).child(message_id).update({
